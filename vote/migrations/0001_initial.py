# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2018-04-02 08:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey_date', models.DateTimeField(default=datetime.datetime(2018, 4, 7, 8, 21, 33, 587708, tzinfo=utc), verbose_name='голосование с')),
                ...
                ('short_description', mezzanine.core.fields.RichTextField(max_length=500, verbose_name='краткое описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pages.Page')),
                ('comment', mezzanine.core.fields.RichTextField(verbose_name='описание')),
                ('content', models.FileField(blank=True, null=True, upload_to='uploads/', verbose_name='файл')),
