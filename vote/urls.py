...
urlpatterns = [
    ...
    url('^about_participate/(?P<participate_id>[0-9]+)$', views.about_participate, name='about_participate'),
    url('^about_competition/(?P<competition_id>[0-9]+)$', views.about_competition, name='about_competition'),
